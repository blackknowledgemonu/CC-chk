...
# Conflict se bachne ke liye official library ko alias diya hai
try:
    import braintree as official_bt
except ImportError:
    print("⚠️ braintree library not found. Check requirements.txt")

# Local files ko safely link karna
try:
    ...
    # Note: braintree_Api ko yahan se hata diya gaya hai kyunki wo error de raha tha
...
if __name__ == '__main__':
    ...
    try:
        # Admin ko signal bhejte hain startup par
